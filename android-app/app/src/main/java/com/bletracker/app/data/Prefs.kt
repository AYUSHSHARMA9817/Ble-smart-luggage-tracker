...
class Prefs(context: Context) {
     ...
     * In production this is baked-in; the setter is kept for backward compatibility
     * but the getter always returns the compile-time constant.
     */
    ...
    private companion object {
        ...
        /** Google OAuth web client ID for production. */
        const val GOOGLE_WEB_CLIENT_ID = "597450044942-5qmmil7kdnos1l25qm4k4fskaif5ltgh.apps.googleusercontent.com"
    }
        ...
        JSONObject()
            ...
            .put("lastPacket", device.lastPacket?.let { packet ->
                JSONObject()
                    ...
                    .put("sensors", packet.sensors?.let { sensors ->
                        JSONObject()
        ...
        return DeviceDto(
            ...
            lastPacket = lastPacketJson?.let {
                ...
                DevicePacketDto(
                    ...
                    sensors = sensorsJson?.let { sensors ->
