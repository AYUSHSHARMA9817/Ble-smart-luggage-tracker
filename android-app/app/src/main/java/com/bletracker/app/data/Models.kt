...
/** Optional sensor readings attached to a telemetry packet. */
data class SensorReadingsPayload(
    val temperatureC: Double?,
    val humidityRh: Double?,
    val lux: Int?,
    val accelXMg: Int? = null,
    val accelYMg: Int? = null,
    val accelZMg: Int? = null,
    val gyroXDps: Double? = null,
    val gyroYDps: Double? = null,
    val gyroZDps: Double? = null,
    val vibrationScore: Int? = null,
)

/** Historical sensor reading returned by `/api/sensor-readings`. */
...
data class SightingPayload(
    ...
    val sensors: SensorReadingsPayload? = null,
)
...
data class BootstrapDto(
    ...
    val sensorRules: List<SensorRuleDto>,
...
/** User-defined alert rule for sensor values returned by backend. */
data class SensorRuleDto(
    val id: String,
    val userId: String,
    val deviceId: String,
    val name: String,
